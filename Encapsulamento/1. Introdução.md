...
* O código original da classe [`Data`](https://github.com/marcoantoni/poo/blob/main/Data.java), que foram desenvolvidos como exemplos nas aulas anteriores.
---
...
* ``public void setDia(int dia)`` - indica que o método altera o valor do atributo dia, sendo ele do tipo inteiro;
* ``public void setNome(String n)`` - indica que o método altera o valor do atributo nome, sendo ele do tipo String;
* ``public void setPeso(float p)`` - indica que o método altera o valor do atributo peso, sendo ele do tipo float;
